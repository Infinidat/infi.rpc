# -*- coding: utf-8 -*-
#
# infi.rpc documentation build configuration file, created by
...
project = u'infi.rpc'
copyright = u'2014, Infinidat Ltd.'
...
latex_documents = [
  ('index', 'infirpc.tex', u'infi.rpc Documentation',
...
man_pages = [
    ('index', 'infirpc', u'infi.rpc Documentation',
     [u'Infinidat Ltd.'], 1)
]
...
texinfo_documents = [
  ('index', 'infirpc', u'infi.rpc Documentation',
   u'Infinidat Ltd.', 'infirpc', 'One line description of project.',
   'Miscellaneous'),
]
